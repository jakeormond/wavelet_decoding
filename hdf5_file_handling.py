...
def create_or_update(hdf5_file, dataset_name, dataset):
    """
...
def read_hdf_memmapped(h5_file_path, dataset_name):
    """
    ...
    def _mmap_h5(h5_file_path, dataset_name):
        with h5py.File(h5_file_path, mode='r') as f:
            ...
            dtype = ds.dtype
            shape = ds.shape
        arr = np.memmap(h5_file_path, mode='r', shape=shape,
                        offset=offset, dtype=dtype)
        return arr
    # Load data
    data = _mmap_h5(h5_file_path, dataset_name)
