'''process the target variables (behaviours) and save them in the HDF5 file.
We will use x and y position, allocentric head direction, and goal direction. 

NOTE: I THINK DATA IS ALREADY PROCESSED CORRECTLY IN THE HDF5 FILE, SO 
MAY NOT NEED TO USE THIS CODE!!!
